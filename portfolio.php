			...
			<div class="col-xs-12 col-md-6">
				<div class="personal_site">
					<div class="personalsite_caption">
						...
						<p><a href="index.php" target="_new" class="btn btn-primary" role="button">Site</a> <a href="https://github.com/jatanbuch" target="_new" class="btn btn-default" role="button">Code</a></p>
					</div>
